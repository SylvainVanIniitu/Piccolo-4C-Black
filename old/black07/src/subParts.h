...
rootFileCount = 0 ; 
    ...
    // sd.vwd()->rewind();
   //  SDcard.chdir(); // est une classe FsVolume, SdFs  
    //    rootFileCount = 0;
  //   while (myFile.openNext(SDcard, O_READ))
  //  {
  //      rootFileCount++;
  //      myFile.close();
 //   }
...
// BLACK06    Serial3.begin(31250);
    ...
    PiccoloVersion = F("Piccolo Black6Hespel2"); // petit subterfuge pour ne rien laisser en mémoire vive
    PiccoloDate = F("21.7.2021");
...
if (synthesePressed == B00010000)  // MUTE seulement
{
