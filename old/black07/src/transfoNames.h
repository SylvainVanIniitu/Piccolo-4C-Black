...
case 371:	NameTransfo = F("Multiplier");	break; // ON OFF pour PAN sur channel et layer spécifique
...
case 462 : NameTransfo = F(">Expand"); break ; // 
...
case 551 : NameTransfo = F("CC Transpose"); break ;
