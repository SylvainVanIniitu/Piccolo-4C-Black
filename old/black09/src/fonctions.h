...
int nowiMask2 = getValueStraightOrFromSequence(iMask2, 0);
do
{
...
{ // Startnote indique la note à partir de laquelle on commence à enregistrer dans la mémoire
	...
	do
	{
		...
		do
		{
			...
			RatioDeltaToMsec = (float)nowNumRatioDeltaToMsec / (float)nowDenomRatioDeltaToMsec;
...
{
	int nowCutOffDureeDelta = getValueStraightOrFromSequence(CutOffDureeDelta, 0);
