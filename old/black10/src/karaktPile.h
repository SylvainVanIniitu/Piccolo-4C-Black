...
void DISMISSint_saveToKMem(int number, int value)
{
    pileKarakt A;
...
void DISMISSbool_saveToKMem(int number, bool value)
{
    pileKarakt A;
...
void DISMISSmulti_int_saveToKMem(int number, int nbLayer, int value[])
{
...
void DISMISSmulti_bool_saveToKMem(int number, int nbLayer, bool value[])
{
    for (int i = 0; i < nbLayer; i++)
    {
        pileKarakt A;
