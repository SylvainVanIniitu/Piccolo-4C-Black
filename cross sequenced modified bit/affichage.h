...
void affichageLine1()
{
    ...
    int potVal2;
    potVal2 = counter2EndUser;

    switch (Transfo[counterEndUser][0])
    {
    ...
    case 82:
    {
        ...
        currentFileNumber = counter2EndUser;
...
*/
    ...
    { // view Channel direction
        ...
        // GetNameTransformation( counter2EndUser );
    ...
    default:
    {
        GetNameTransformation(Transfo[counterEndUser][0]);
        printRot2(NameTransfo, 11, 400, 2);
    }
    break;
...
void affichageLine2(int thisTransfo)
{
    ...
    { // MULTIPLY
        ...
        int potVal3 = (counter2EndUser / 7) + 1;
        potVal2 = (counter2EndUser % 7) + 1;
    ...
    { // AUTO FX
        ...
        // // old potVal2 mapping ;
        // potVal2 = map(potVal2, 0, 1023, Transfo[counterEndUser][1] , Transfo[counterEndUser][2] + 1); // dépendra de l'effet choisi.
    ...
    { // REP FRACT TODO DEBUG ne marche pas je crois
        ...
        int potVal3 = (counter2EndUser / 16) + 1;
        potVal2 = (counter2EndUser % 16) + 1;
    ...
    case 93:
    {
        ...
        //  printRot2(midiFileInfo, 16, 400, 5); // 2C27
    ...
    case 134:
    {
        ...
        else if (Evenement[CurrentEvenement].type == 2)
        {
            ...
            //affichageLine2(counter2EndUser) ;
    ...
    { // NUM VLV to midiSec midi glitch
        ...
        affiche = nulString;
        affiche = String(potVal2) + "/" + String(DenomRatioDeltaToMsec);
    ...
    { // DENOM VLV to midiSec midi glitch
        ...
        // affiche =  nulString ; ;
        //
        affiche = String(NumRatioDeltaToMsec) + "/" + String(potVal2);
    ...
    case 186: // Fregoli-ze cette note
    {
        ...
        // potVal2 = map(counter2, 0, 1023, Transfo[counterEndUser][1] , Transfo[counterEndUser][2]  ) ;
    ...
    case 200: //  Add CC Mod
    {
        ...
        //
        // CCModPtr = giveNthPtrPileComplete(CCModPointeurInitial, currentCCMod);
        // boolean actif = (*CCModPtr).CCMod.actif ;
        boolean actif = CCModTableau[currentCCMod].actif;
    ...
    { // SET ACTION for Sequence
        ...
        {
        case 0:
            affiche += (F("1.Send CC")); // DONE
            break;
        case 1:
            affiche += (F("2.Pitch ADD")); // DONE
            break;
        case 2:
 ...
 // affiche += GiveNameOfMode(potVal2);
    ...
    {
        // affiche = "Layer " + String(potVal2);
        // if (pitchableLayer[potVal2 - 1] == false)
        // {
        //     affiche += " OFF";
        // }
        // else
    ...
    { // DYNAMIC SWING
        //     affiche = String(potVal2);
        //     valueDynamicSwing = potVal2 ;
        //     affiche += F("  ");

        //     if (dynamicSwing == true)
        //     {
        //         affiche += (F("ON "));
        //     }
        //     else
    ...
    case 424: // STEPZ
    {
        ...
        for (int i = 0; i < nbLayer; i++)
        {
            if (isLayerActive(i))
            {
                ...
                // premier affichage rudimentaire, qui donne stepz et substepz
                /*  buffer_and_HARD_setCursor(0,3+i);
        u8x8.clearLine(3+i);
        for ( unsigned int j = 0 ; j < nbCases ; j++ ) {
        buffer_and_HARD_print(tableauSubStepz[j]); 
    ...
    case 441: // PUNTZ
    {
        // qd affichage de PUNTZ, on lit les stpez comme des valeurs de vélocité !
        ...
        for (int i = 0; i < nbLayer; i++)
        {
            if (isLayerActive(i))
            {
                ...
                int pos = (nowMillis % layerLength[i]) / (layerLength[i] / nbStepz);
                affiche = nulString;
                affiche = String(currentPageStepz);
                affiche += ":";
...
*/
    ...
    case 512: // LAPIDZ, basé sur STEPZ
    {
        ...
        int tailleVariations;

        if (Transfo[counterEndUser][0] == 512 && counterEndUser != oldcounter)
        {
            //  firstTime512 = true;
            ...
            for (int i = 0; i < nbLayer; i++)
            {
                if (isLayerActive(i))
                {
                    // if (variationLayer[i] == true)
                    {
                        ...
                        Transfo[counterEndUser][2] = tailleVariations; // indique le maximum pour potVal2
