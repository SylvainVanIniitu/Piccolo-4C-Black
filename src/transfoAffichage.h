...
// CHANNEL et NOTE, pour PAGE
    ...
    case 552: // verbose Serial
    {
        ...
        {
            affiche = "order : " ;
            affiche += (verboseSerial_OrderGiven == true ? F("ON ") : F("OFF"));
...
///////////////////////
    ...
    {
        affiche = nulString;
        affiche += afficheValueStraightOrFromSequence(potVal2, " CH", 1);
        printRot2(affiche, 16, 400, 3);
    }
    break;

    case 622: // CH size Pinch
    {
        affiche = nulString;
        affiche += afficheValueStraightOrFromSequence(potVal2, " items", 1);
        printRot2(affiche, 16, 400, 3);
    }
    break;
    ...
    {
        affiche = nulString;
        affiche += afficheValueStraightOrFromSequence(potVal2, " CC", 0);
        printRot2(affiche, 16, 400, 3);
    }
    break;

    case 624: // CC size Pinch
    {
        affiche = nulString;
        affiche += afficheValueStraightOrFromSequence(potVal2, " items", 1);
        printRot2(affiche, 16, 400, 3);
    ...
    case 625: // value Pinch
    {
        affiche = nulString;
        affiche += afficheValueStraightOrFromSequence(potVal2, " value", 0);
        printRot2(affiche, 16, 400, 3);
    }
    break;

    case 629 :  // affichage sequence Narayana 
    {
    ...
    case 630: // jeu note channel note+channel 
    {
        ...
        case 1:
            ...
            break;
        case 2:
            affiche += (F("2.Channels"));
            break;
        case 3:
            affiche += (F("3.Channels+Notes"));
            break;
        default:
            affiche += (F("--------- "));
            break;
