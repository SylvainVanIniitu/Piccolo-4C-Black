...
int Transfo[][5] = {
    ...
    {620, 0, 63, TRANSFO_NO_VALUE}, // enregistre REC flux dans MEM, v2, 22C01 ON et OFF

    {627, 1, 20, TRANSFO_SIMPLE_VALUE},  // Narayan's cows - juillet 2022
    {628, 0, 127, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-initial pitch"); break ;  //	int initialPitch = 64;						 // should be 64 : E
    {629, 1, 9, TRANSFO_NO_VALUE},  // : NameTransfo = F("-scale"); break ;  //	const int tailleScale = 2;					 // should be 2
  {630, 1,3, TRANSFO_NO_VALUE}, // 1 = note 2 = CH 
    {631, 1, 20, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-maturite"); break ;  //	int maturite = 4;							 // should be 4
    {632, 1, 1270, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-menopause"); break ;  //	int menopause = 1000;						 // should be infinite
    {633, 1, 1270, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-death age"); break ;  //	int mort = 1000;							 // should be infinite
    {634, 1, 1270, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-age first cow"); break ;  //	int ageInitialPremiereVache = 4;			 // should be 4
    {635, 1, 20, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-children"); break ;  //	int taillePortee = 1;						 // nombre de veaux qui naissent en même temps : should be 1
    {636, 1, 100, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-unexpec death"); break ;  //	int mortaliteFortuite = 0;					 // en % les veaux et vaches qui meurrent aléatoirement : should be 0

    {637, 1, 300, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-bpm"); break ;  //	long Naranaya_BPM = 200;
   // {638, 1, 60, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-duree cow"); break ;  //	long dureeVache = (60 * 1000) / Naranaya_BPM;
    {639, 1, 5, TRANSFO_SIMPLE_VALUE}, // : NameTransfo = F("-duree calf"); break ;  //	long dureeVeau = dureeVache / 2; // should be 2

    {626, 0, 0, TRANSFO_NO_VALUE},                    // pinch
    {621, 1 - nbSequencesMax, 16, TRANSFO_NO_VALUE},  // pinch CH
    {622, 1 - nbSequencesMax, 64, TRANSFO_NO_VALUE},  // pinch CH size
    {623, 0 - nbSequencesMax, 127, TRANSFO_NO_VALUE}, // pinch CC
    {624, 1 - nbSequencesMax, 64, TRANSFO_NO_VALUE},  // pinch CC size
    {625, 0 - nbSequencesMax, 127, TRANSFO_NO_VALUE}, // pinch value

    {603, 2, 32, TRANSFO_NO_VALUE},      // Génère une bassline sur n steps ACID
    {604, 1, 16, TRANSFO_SIMPLE_VALUE},  //    case 604 : NameTransfo = F(">Acid CH"); break; //	int acid_CH = 0; // CH pour la bassline Acid
    {605, 0, 100, TRANSFO_SIMPLE_VALUE}, // case 605 : NameTransfo = F(">Acid Full ratio"); break; //	int acidNbFullNote = 10;
    {606, 0, 100, TRANSFO_SIMPLE_VALUE}, // case 606 : NameTransfo = F(">Acid Empty ratio"); break; //	int acidNbEmptyNote = 7;
    {607, 0, 100, TRANSFO_SIMPLE_VALUE}, // case 607 : NameTransfo = F(">Acid Short ratio"); break; //	int acidNbShortNote = 3;
    {608, 0, 100, TRANSFO_SIMPLE_VALUE}, // case 608 : NameTransfo = F(">Acid triplet ratio"); break; //	int acidNbTripletNote = 2;
    {609, 0, 100, TRANSFO_SIMPLE_VALUE}, // case 609 : NameTransfo = F(">Acid slide ratio"); break; //	int acidNbSlideNote = 5;
    {610, 0, 127, TRANSFO_SIMPLE_VALUE}, // case 610 : NameTransfo = F(">Acid min pitch (24)"); break; //	int acidPitchMin = 24; // pour Bhringer TD3
    {611, 0, 127, TRANSFO_SIMPLE_VALUE}, // case 611 : NameTransfo = F(">Acid max pitch (80)"); break; //	int acidPitchMax = 72; // pour Behringer TD3
    {612, 0, 127, TRANSFO_SIMPLE_VALUE}, // case 612 : NameTransfo = F(">Acid min vel"); break; //	int acidVelocityMin = 80;
    {613, 0, 127, TRANSFO_SIMPLE_VALUE}, // case 613 : NameTransfo = F(">Acid max vel"); break; //	int acidVelocityMax = 120;
    {614, 1, 8, TRANSFO_SIMPLE_VALUE},   // Acid Divide : division des bursts, typiquement 3

    {535, 0, nbSequencesMax, TRANSFO_NO_VALUE}, // Tracker ON/OFF + Sequence
    {581, 0, nbSequencesMax, TRANSFO_NO_VALUE}, // Tracker Karakt ON/OFF + Sequence
    {586, 0, 0, TRANSFO_NO_VALUE},              // Trackerz Stop

    {582, 0, 8, TRANSFO_NO_VALUE}, // Select Keyboard type

    {587, 1, 16, TRANSFO_SIMPLE_VALUE}, // Decalagem VELocity

    {583, 0, 512 * 256, TRANSFO_NO_VALUE}, // Send DMX value
    {584, 0, 0, TRANSFO_NO_VALUE},         // DMX auto Generate v1
    {589, 0, 512 * 256, TRANSFO_NO_VALUE}, // pinch DMX value in layer

    {590, -nbSequencesMax, 200, TRANSFO_NO_VALUE},   // Vertical slide CC
    {591, -nbSequencesMax, 10000, TRANSFO_NO_VALUE}, // horizontal slide CC
    {592, -nbSequencesMax, 200, TRANSFO_NO_VALUE},   // Vertical slide note
    {593, -nbSequencesMax, 10000, TRANSFO_NO_VALUE}, // horizontal slide note
    {594, 2, 32, TRANSFO_SIMPLE_VALUE},              // multiplier empty

    {601, 2 - nbSequencesMax, 64, TRANSFO_NO_VALUE}, // génère stepz rnd de CC
    {602, 0, 16 * 127, TRANSFO_NO_VALUE},            // choix CH CC
    ...
    {588, -200, 200, TRANSFO_PERCENT},  // decalagemSwing ( -99 à +99 regular, après outside ! )

    {570, 1 - nbSequencesMax, 30000, TRANSFO_NO_VALUE}, // Sustain Blocker : SEQ OK
    {571, 1 - nbSequencesMax, 30000, TRANSFO_NO_VALUE}, // Proxy Pitcher
    {572, -24 - nbSequencesMax, 24, TRANSFO_NO_VALUE},  // proxy pitch value SEQ!BLACK08
    ...
    {567, 0, 5, TRANSFO_NO_VALUE},               // type Filtre pour AutoHarmonize Live Playing
    ...
    {595, -nbSequencesMax, 100, TRANSFO_NO_VALUE}, // gabbUltrino vBlack10preRelease1
    {596, 0, nbSequencesMax, TRANSFO_NO_VALUE},    // choix de séquence présidant au choix de notes
    {597, 0 * 0, 15 * 127, TRANSFO_NO_VALUE},      // set all CC to mentionned CH & CC
    ...
    {548, 0, 128, TRANSFO_NO_VALUE}, // POLYZ choix des notes polyrythmiques
                                     // DEBUG attention cette transfo modifie nbStepz et nbSubStepz :
                                     // il faut la réécrire
                                     // de plus lapidz chiffone l'affichage des valeurs

    {512, 1, 3000, TRANSFO_NO_VALUE}, // LAPIDZ choix des notes parmi celles qui existent au début
    ...
    {441, 0, 128, TRANSFO_NO_VALUE},  /// PUNTZ choix de la note qui va être balancée
                                      // DISMISS BLACK09 ???  je ne vois plus l'intérêt avec le choix de vélocité par fader det Alt-Rot
                                      // en fait si, on peut insérer une note sans clavier !
    ...
    {585, 2, 7, TRANSFO_NO_VALUE}, // Ezy Multiplier
...
*/
    ...
    {444, 0 - nbSequencesMax, 300, TRANSFO_NO_VALUE}, // SEQ! Dende Sec
    {445, 0 - nbSequencesMax, 4999, TRANSFO_MSEC},    // SEQ! msec
    {486, 0 - nbSequencesMax, 64, TRANSFO_NO_VALUE},  // time Dende en 32èmes
    {446, 0 - nbSequencesMax, 36, TRANSFO_NO_VALUE},  // SEQ! divide
    {447, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE}, // SEQ! drop   !!! différent de Dende Original
    {448, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE}, // SEQ! down    !!! différent du Dende Original : -100 à 100 -> 0 à 200
    {449, 1 - nbSequencesMax, 4, TRANSFO_NO_VALUE},   // SEQ! levels
    {450, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // SEQ! decay -> branch
    {451, 0 - nbSequencesMax, 36, TRANSFO_NO_VALUE},  // SEQ! start
    {452, 0 - nbSequencesMax, 36, TRANSFO_NO_VALUE},  // SEQ! end
    {453, 0 - nbSequencesMax, 400, TRANSFO_NO_VALUE}, // SEQ! ratio
    {454, 0 - nbSequencesMax, 400, TRANSFO_NO_VALUE}, // SEQ! stretch
    {456, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // SEQ! fidelity %appear
    {467, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // SEQ! subFidelity  %happen

    {458, -99 - nbSequencesMax, 200, TRANSFO_NO_VALUE}, // retard

    {455, -24 - nbSequencesMax, 24, TRANSFO_NO_VALUE},  // pitch
    {461, -12 - nbSequencesMax, +12, TRANSFO_NO_VALUE}, // degres
    // Attention, si on modifie une valeur dans un espace
    // où on a valeur - nbSequencesMax,
    // il faut tenir compte que pour affichage et valeur finale, on doit changer le floor
    // dans affichageStraight et getValueStraight !!!

    {463, -12 - nbSequencesMax, 12, TRANSFO_NO_VALUE}, // arp1
    {464, -12 - nbSequencesMax, 12, TRANSFO_NO_VALUE}, // arp2
    {459, 0, 12, TRANSFO_NO_VALUE},                    // gamme
    {460, 0, 14, TRANSFO_NO_VALUE},                    // mode
    {465, 0 - nbSequencesMax, 3, TRANSFO_NO_VALUE},    // noteOff
    {468, 0 - nbSequencesMax, 255, TRANSFO_NO_VALUE},  // BitMap - en nég sera pour Seq  ! :)  YEAH
    {457, 1, 1000, TRANSFO_SIMPLE_VALUE},              // overlaod
    {462, 1, 12, TRANSFO_SIMPLE_VALUE},                // expand : DELETE ???
...
*/
    ...
    {328, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},      // nombre de délais - négatif = SEQ
    {329, -1000 - nbSequencesMax, 1000, TRANSFO_NO_VALUE}, // espacement des délais
    {330, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE},      // DROP velocity
    {331, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE},      // DOWN Velocity
    {332, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},      // Random Percent
    {568, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},      // Random Appear pour Delay

    {333, 0 - nbSequencesMax, 128, TRANSFO_NO_VALUE}, // Repeater - valeur négatives = SEQ
    {334, 0 - nbSequencesMax, 255, TRANSFO_NO_VALUE}, // BitMap - valeur négatives = SEQ
    ...
    // pas sûr de garder ceci ! fait double emploi avec Delay !
    {598, 1 - nbSequencesMax, 1000, TRANSFO_NO_VALUE}, // premonition
    {599, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE},  // prem velocity %
    {600, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},  // prem random

    /*
DECALAGES
 */

    {216, 0 - nbSequencesMax, 1000, TRANSFO_NO_VALUE}, // valeur du Poof ( deviation random )

    {398, 0, 0, TRANSFO_NO_VALUE},                         // Drunk ON/OFF
    {399, -1000 - nbSequencesMax, 1000, TRANSFO_NO_VALUE}, // Min
    {400, -1000 - nbSequencesMax, 1000, TRANSFO_NO_VALUE}, // Max
    {401, 0 - nbSequencesMax, 1000, TRANSFO_NO_VALUE},     // step

    {205, 0 - nbSequencesMax, 1000, TRANSFO_NO_VALUE},  // dureePole1
    {206, -10 - nbSequencesMax, +10, TRANSFO_NO_VALUE}, // min POle1
    {207, -10 - nbSequencesMax, +10, TRANSFO_NO_VALUE}, // max POle1
    {208, 0 - nbSequencesMax, 1000, TRANSFO_NO_VALUE},  // dureePole2
    {209, -10 - nbSequencesMax, +10, TRANSFO_NO_VALUE}, // min POle2
    {210, -10 - nbSequencesMax, +10, TRANSFO_NO_VALUE}, // max POle2
    {211, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},   // freq Pole 1
...
*/
    ...
    {355, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Random Percent
    {356, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Sym Horizontale 100 = parfait ; 0 = inversé
    {357, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Sym Verticale 100 = parfait ; 0 = inversé
    {358, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Reflet  100 = hors de l'eau ; 0 = inversé par l'horizontale
    {366, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Pre Reflet : avant descente
    {367, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Pre H
    {368, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Pre V

    {381, 0, 0, TRANSFO_NO_VALUE},                      // Kannon ON/OFF
    {382, 0 - nbSequencesMax, 10000, TRANSFO_MSEC_SEQ}, // Kannon delay : NEW 2C03 les valeurs négatives sont des séquences
                                                        // ici je redécouvre propriété de MSEC : qd négatif, d'office SEQ !

    {383, -36 - nbSequencesMax, +36, TRANSFO_NO_VALUE}, // pitch shift du Kannon

    {569, 0 - nbSequencesMax, 200, TRANSFO_NO_VALUE}, // drop velocité du Kannon
    // valeur sous 36 sont des séquences
    {384, 0 - nbSequencesMax, +50, TRANSFO_NO_VALUE}, // stretch du layer : en dixième de durée, ou 16èmes ?
    // valeur négatives sont des séquences
    {385, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Revert : à l'écrevisse
    {386, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Reflet : modifie le pitch en fc du plus élevé et plus bas
    {387, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Kannon Random happen
    {532, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Kannon random appear
    {533, 1 - nbSequencesMax, 17, TRANSFO_NO_VALUE},  // CH destination : 1-16 = spécifique 17 idem
...
*/
    ...
    {375, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // OMIT end
...
*/
    ...
    {349, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Dynamic Swing
...
*/
    ...
    {47, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // Fidelity
...
*/
    ...
    {126, 0, SizeTransfo, TRANSFO_NO_VALUE}, // DEFINE .which CC or Transfo
...
*/
    ...
    {615, -36, 36, TRANSFO_DEMITONS}, // Transpose la valeur MIDI play

    {616, 0 - nbSequencesMax, 10000, TRANSFO_SIMPLE_VALUE}, // new lo VLV cut
    {617, 0 - nbSequencesMax, 10000, TRANSFO_SIMPLE_VALUE}, // bring to if lower
    {618, 0 - nbSequencesMax, 10000, TRANSFO_SIMPLE_VALUE}, // new hi VLV cut
    {619, 0 - nbSequencesMax, 10000, TRANSFO_SIMPLE_VALUE}, // bring to if higher

    {151, 1 - nbSequencesMax, 1000, TRANSFO_NO_VALUE},     // GLITCH NumRatioDeltaToMsec
    {152, 1 - nbSequencesMax, 1000, TRANSFO_NO_VALUE},     // GLITCH DenomRatioDeltaToMsec
    {560, 1 - nbSequencesMax, 20000, TRANSFO_NO_VALUE},    // GLITCH NumRatioDeltaToMsec DenomRatioDeltaToMsec RatioDeltaToMsec
    {563, -7, 7, TRANSFO_NO_VALUE},                        // multiplication de ratio
    {142, 0 - nbSequencesMax, 100, TRANSFO_SIMPLE_VALUE},  // GLITCH iVLVDelta
    {143, 0 - nbSequencesMax, 100, TRANSFO_SIMPLE_VALUE},  // GLITCH iDureeDelta
    {144, 0 - nbSequencesMax, 100, TRANSFO_SIMPLE_VALUE},  // GLITCH imididouble = 0;
    {145, 0 - nbSequencesMax, 16, TRANSFO_SIMPLE_VALUE},   // GLITCH iShiftDelta = 8 ;
    {146, 0 - nbSequencesMax, 16, TRANSFO_SIMPLE_VALUE},   // GLITCH iShiftDuree = 7 ;
    {147, 0 - nbSequencesMax, 255, TRANSFO_SIMPLE_VALUE},  // GLITCH iDureeMask = B01111111   ;
    {148, 0 - nbSequencesMax, 255, TRANSFO_SIMPLE_VALUE},  // GLITCH iMask2 = B10000000 ;
    {149, 0 - nbSequencesMax, 2000, TRANSFO_SIMPLE_VALUE}, // GLITCH CutOffDureeDelta
    {150, 0 - nbSequencesMax, 2000, TRANSFO_SIMPLE_VALUE}, // GLITCH BringToDureeDelta
    {296, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE},      // FUNKY VELocity pour Midi Player
...
*/
    ...
    {226, floorSeq - nbSequencesMax, +2000, TRANSFO_NO_VALUE}, // Define Sequence.
    ...
    // pour CROSS SEQUENCE, on définira en dessous de -200 les SEQ

    {229, 0, nbSequencesMax - 1, TRANSFO_NO_VALUE}, // Erase 1 Digit from Sequence
    {230, 0, 12, TRANSFO_NO_VALUE},                 // Set Sequence Type
    // TODO coder le Markov : on indique 3 premières values qui déterminent
    // le pourcentage de retour en arrière, d'aller en avant, et de self
    // = real Markov
    ...
    // BLACK 10 : afficher m-M UP m-M DOWN m-M STATIC + jeu des ctrl shift alt pour aller vite

    {237, 0, tailleMaxTableauSequence, TRANSFO_NO_VALUE}, // Set rnd Frag Size
    {238, 0, 100, TRANSFO_NO_VALUE},                      // Set rnd Frag repeats
    // BLACK 10 : afficher Frag Size - frag repeat

    {239, 0, 26, TRANSFO_NO_VALUE},                 // Set ACTION
...
*/
    ...
    {283, 0 - nbSequencesMax, 100, TRANSFO_NO_VALUE}, // FIdelity Whole Layer
...
*/
    ...
    {580, 1, 174 * 8, TRANSFO_NO_VALUE} // le premier chiffre indique le nb de BPM, le second le nb de bars
};

// qd on est au-dessus de la première transfo d'une catégorie, on envoie à la suivante
const int jump[] = {24, 573, 424, 466, 327, 216, 472, 420, 351, 372, 111, 58, 119, 108, 64, 127, 167, 190, 218, 228, 244, 311, 340, 24};
